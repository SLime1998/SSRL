...
class FT_Processor(Processor):
    ...
    def load_model(self):
        ...
        for name, param in self.model.encoder.named_parameters():
            ...
            if name.find('st_gcn_networks.9')!=-1:
                param.requires_grad = True
            if name.find('st_gcn_networks.8')!=-1:
                param.requires_grad = True
            if name.find('st_gcn_networks.7')!=-1:
                param.requires_grad = True
            if name.find('st_gcn_networks.6')!=-1:
                param.requires_grad = True
            if name.find('st_gcn_networks.5')!=-1:
                param.requires_grad = True
            if name.find('st_gcn_networks.4')!=-1:
                param.requires_grad = True
            if name.find('st_gcn_networks.3')!=-1:
                param.requires_grad = True
