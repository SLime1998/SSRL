...
if __name__ == '__main__':
    ...
    parser.add_argument('--dataset_path', default='/home/external_1/jzh/dataset/ntu120')
    parser.add_argument('--out_folder', default='/home/external_1/jzh/dataset/ntu120_50frame')
